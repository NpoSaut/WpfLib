...
namespace DesignUtils
{
    public static class DesignTime
    {
        public static readonly DependencyProperty BackgroundProperty = DependencyProperty.RegisterAttached(
            "Background", typeof (Brush), typeof (DesignTime), new PropertyMetadata(default(Brush), SetBackgroundCallback));
        ...
        private static void SetBackgroundCallback(DependencyObject O, DependencyPropertyChangedEventArgs PropertyChangedEventArgs)
        {
